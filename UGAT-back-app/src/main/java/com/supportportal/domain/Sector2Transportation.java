...
@Table(name = "sector2_transportation")
@Entity
public class Sector2Transportation implements Serializable {
    @Id
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Sector2Transportation)) return false;
        Sector2Transportation that = (Sector2Transportation) o;
